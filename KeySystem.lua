...
local Config = {
    ...
    ServiceId       = 26863, -- Your PlatoBoost Service ID
    PlatoSecret     = "e7707543-e17a-4dfe-82e5-3fe630c95e01", -- Your PlatoBoost Secret Key
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/Dekkosploits/ECHO---THE-MIMIC/refs/heads/main/Script.lua", -- The raw URL of your main script
    ...
    ShowYoutube     = true,
    YoutubeURL      = "https://www.youtube.com/channel/@jadenpackinsum",
    ...
    HubName         = "ECHO - THE MIMIC", -- The main title shown at the top of the GUI
